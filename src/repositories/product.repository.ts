...
export const productRepository = {
  ...
  create: (data: {name: string; pricePerUnit: number; companyId: string; description?: string}) =>
    prisma.product.create({data, select}),
  update: (id: string, data: {name?: string; description?: string; pricePerUnit?: number}) =>
